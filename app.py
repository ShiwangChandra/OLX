...
def predict():
    if request.method =="POST":
        ...
        print(make,model,year,kms,fuel,reg_city,car_doc,assembly,transmission)
        ...
        res = mymodel.predict([[int(year),int(kms),mkenc,mdlenc,flenc,rgctenc,cardcdnc,assenc,trenc]])
        print(res[0])
